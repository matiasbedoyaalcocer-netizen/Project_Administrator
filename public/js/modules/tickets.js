    ...
    renderView() {
        ...
        if (this.tickets && this.tickets.length > 0) {
            ...
            sorted.forEach(t => {
                ...
                const imageStr = t.image ? `<img src="${t.image}" class="receipt-thumbnail" data-src="${t.image}" style="object-fit:cover; border-radius:12px; height:120px; width:100px; cursor:pointer;" alt="Comprobante" onclick="window.openImageModal(this.dataset.src)">` : `<i class='bx bx-receipt' style="font-size:3rem; color:var(--text-muted);"></i>`;
